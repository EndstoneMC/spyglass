...
void field_line(std::string &out, std::string_view key, const nlohmann::ordered_json &value, bool full);
std::string report_node(const nlohmann::ordered_json &node, int depth, bool full);
