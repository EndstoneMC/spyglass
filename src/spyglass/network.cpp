                                           ...
                                           const SubClientId &sub_id)
{
    ...
    if (kBreakFirstSubChunk && id == kSubChunkPacket && !g_broke_one.exchange(true)) {
        ...
        spyglass::View::getInstance().onPacketReceive({
            ...
            .fields = spyglass::needs_live_registry(getName()) ? spyglass::decode_fields(*this, id)
    ...
    spyglass::View::getInstance().onPacketReceive({
        ...
        .fields =
            spyglass::needs_live_registry(getName()) ? spyglass::decode_fields(*this, id) : nlohmann::ordered_json{},
