...
public:
    ...
    [[nodiscard]] bool isChannelPaused(std::uint32_t channel) const { return paused_channels_.test(channel); }
    void setChannelPaused(std::uint32_t channel, bool paused) { paused_channels_.set(channel, paused); }
